...
hamile_diyabetli=df[((df["Pregnancies"]>5) & df["Outcome"]==1)]  #5 ten büyükse internetteki verilere göre kesin hamiledir.
...
df.tail(10)#sondan 10 veriyi gösterdik.

plt.figure(figsize = [20, 5] , dpi = 100) 
plt.scatter (df["BMI"] , df["Age"] , color = "blue") # iki numeric (sayısal) değere sahip parametre arasındaki ilişkiyi noktalar ile göstermekte.
plt.title ("Yaş ve Vücut Kitle Endeksi Arasındaki ilişki " , weight = 'bold', fontsize = 30)
plt.xticks (range (0 , 80 , 10) , fontsize = 10 )#xAralık belirle.x dahil,y dahil değil,z boyut.
